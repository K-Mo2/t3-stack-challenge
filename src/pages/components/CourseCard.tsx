...
export default function CourseCard(props:Course) {
    ...
    const navigateToCourse = async function(){
        await router.push(`courses/${props.id}`)
    }
  return (
    
    <div onClick={()=> void navigateToCourse()} className='flex bg-purple-300 flex-col justify-around items-center shadow-md w-2/12 mx-4 rounded h-1/4 cursor-pointer'>
